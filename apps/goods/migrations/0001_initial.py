# Generated by Django 2.2.8 on 2020-03-05 19:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_sn', models.CharField(default='', max_length=50, unique=True, verbose_name='商品货号')),
                ...
                ('goods_brief', models.TextField(default=0, verbose_name='商品简短描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', max_length=32, verbose_name='类别code')),
                ('desc', models.TextField(default='', max_length=64, verbose_name='类别描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=32, verbose_name='品牌名')),
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='goods', to='goods.GoodsCategory', verbose_name='商品类目'),
        ),
        migrations.CreateModel(
            name='Banner',
            fields=[
